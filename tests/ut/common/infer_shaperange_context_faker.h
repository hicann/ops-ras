...
#ifndef OPS_RAS_DEV_TESTS_UT_COMMON_INFER_SHAPERANGE_CONTEXT_FAKER_H
#define OPS_RAS_DEV_TESTS_UT_COMMON_INFER_SHAPERANGE_CONTEXT_FAKER_H
...
public:
    ...
    InferShapeRangeContextFaker& NodeAttrs(const std::vector<std::pair<std::string, Ops::Ras::AnyValue>>& attrs);

    KernelRunContextHolder Build();
};
} // namespace gert
#endif // OPS_RAS_DEV_TESTS_UT_COMMON_INFERSHAPERANGE_CONTEXT_FAKER_H
