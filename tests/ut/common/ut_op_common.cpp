...
static const std::map<std::string, Ops::Ras::AnyValue::ValueType> kAttrTypesMap = {
  {"VT_INT", Ops::Ras::AnyValue::ValueType::VT_INT},
  {"VT_BOOL", Ops::Ras::AnyValue::ValueType::VT_BOOL},
  {"VT_FLOAT", Ops::Ras::AnyValue::ValueType::VT_FLOAT},
  {"VT_STRING", Ops::Ras::AnyValue::ValueType::VT_STRING},
  {"VT_LIST_INT", Ops::Ras::AnyValue::ValueType::VT_LIST_INT},
  {"VT_LIST_BOOL", Ops::Ras::AnyValue::ValueType::VT_LIST_BOOL},
  {"VT_LIST_FLOAT", Ops::Ras::AnyValue::ValueType::VT_LIST_FLOAT},
  {"VT_LIST_LIST_INT", Ops::Ras::AnyValue::ValueType::VT_LIST_LIST_INT},
};
      ...
      if (attr_it != op_attrs_map.end()) {
        ...
        if (type_it != kAttrTypesMap.end()) {
          switch (type_it->second) {
            case Ops::Ras::AnyValue::ValueType::VT_BOOL: {
              bool value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
                faker.Attr(item, value);
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_INT: {
              int64_t value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
                faker.Attr(item, value);
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_FLOAT: {
              float32_t value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
                faker.Attr(item, value);
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_STRING: {
              std::string value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
              faker.Attr(item, AscendString(value.c_str()));
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_LIST_INT: {
              std::vector<int64_t> value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
                faker.Attr(item, value);
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_LIST_FLOAT: {
              std::vector<float32_t> value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
                faker.Attr(item, value);
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_LIST_BOOL: {
              std::vector<bool> value;
              if(op.GetAttr(item, value) != GRAPH_SUCCESS) return GRAPH_FAILED;
                faker.Attr(item, value);
            }
            break;
            case Ops::Ras::AnyValue::ValueType::VT_LIST_LIST_INT: {
