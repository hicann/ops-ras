...
#ifndef OPS_RAS_DEV_TESTS_UT_COMMON_OP_IMPL_REGISTRY_H
#define OPS_RAS_DEV_TESTS_UT_COMMON_OP_IMPL_REGISTRY_H
...
namespace gert {
    using OpImplRegistry = Ops::Ras::OpImplRegistry;
}

#endif  // OPS_RAS_DEV_TESTS_UT_COMMON_OP_IMPL_REGISTRY_H