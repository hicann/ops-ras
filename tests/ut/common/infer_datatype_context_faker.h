...
#ifndef OPS_RAS_DEV_TESTS_UT_COMMON_INFER_DATATYPE_CONTEXT_FAKER_H
#define OPS_RAS_DEV_TESTS_UT_COMMON_INFER_DATATYPE_CONTEXT_FAKER_H
...
public:
    ...
    InferDataTypeContextFaker& NodeAttrs(const std::vector<std::pair<std::string, Ops::Ras::AnyValue>>& attrs);

    KernelRunContextHolder Build();
};
} // namespace gert
#endif // OPS_RAS_DEV_TESTS_UT_COMMON_INFER_DATATYPE_CONTEXT_FAKER_H
