...
public:
    ...
    virtual void SetUp() {
        ...
        /* load libras_op_kernel_ut_${socversion}_ut.so for init tiling funcs and infershape funcs */
        ...
        string opKernelTilingSoPath = buildPath + string("/tests/ut/op_kernel/libras_op_kernel_ut_tiling.so");
        gert::OppSoDesc oppSoDesc({ge::AscendString(opKernelTilingSoPath.c_str())}, "ras_op_kernel_ut_so");
