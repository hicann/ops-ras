...
bool CacheTilingContext::Save(TilingContext& context) {
  ...
  if (workspaceNum > 0) {
    ...
    if (memcpy_s(workspace.get(), workspaceNum * sizeof(size_t), ge_workspace, workspaceNum * sizeof(size_t)) != EOK) {
      return false;
    }
  }
  return true;
...
bool CacheTilingContext::Load(TilingContext& context) const {
  ...
  if (workspaceNum > 0) {
    ...
    if (memcpy_s(ge_workspace, workspaceNum * sizeof(size_t), workspace.get(), workspaceNum * sizeof(size_t)) != EOK) {
      return false;
    }
  }
  return true;
