...
namespace {
static const std::string OPHOST_BUILTIN_SO_NAME = "libophost_ras.so";
static const std::string OPHOST_CUSTOM_SO_NAME = "libcust_opmaster_rt2.0.so";
static const std::string OPAPI_BUILTIN_SO_NAME = "libopapi_ras.so";
...
static const Ops::Ras::LegacyCommonMgr LEGACY_COMMMON_MGR;
} // namespace
    ...
    const std::string& parentPath, const std::string& currSoName, std::string& soPath) const
{
    ...
    if (currSoName == OPHOST_CUSTOM_SO_NAME) {
        // 路径：opp/vendors/custom_ras/op_impl/ai_core/tbe/op_tiling/lib/linux/$(arch)/libcust_opmaster_rt2.0.so
        oppPath = "/../../../../../../../../../../opp";
    } else if (currSoName == OPAPI_CUSTOM_SO_NAME) {
        // 路径：opp/vendors/custom_ras/op_api/lib/libcust_opapi.so
        oppPath = "/../../../../../opp";
    } else {
        return false;
    }
