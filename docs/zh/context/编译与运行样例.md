...
- **示例代码**
   ...
   已知AddMatMul算子实现了张量加法运算，计算公式为：out = β  self + α  (mat1 @ mat2)。您可以从[aclnnAddmm&aclnnInplaceAddmm.md](https://gitcode.com/cann/ops-nn/blob/9.0.0/matmul/mat_mul_v3/docs/aclnnAddmm&aclnnInplaceAddmm.md)中“调用示例”获取示例代码，并将代码文件命名为“**test\_addmm.cpp**”。
