...
function(pack_built_in)
  ...
  set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "CANN reliability operator library")
  set(CPACK_RPM_PACKAGE_LICENSE "CANN Open Software License Agreement Version 2.0")
  # Older offline cann-cmake caches silently ignore PACKAGE_TYPE and produce a run package.
  if(NOT PACKAGE_TYPE STREQUAL "run")
    file(READ "${CANN_CMAKE_DIR}/function/prepare.cmake" cann_cpack_source)
    if(NOT cann_cpack_source MATCHES "CANN_PACKAGE_TYPE")
      message(FATAL_ERROR "deb/rpm packaging requires a cann-cmake version supporting PACKAGE_TYPE; refresh your cann-cmake cache to master-057")
    endif()
  endif()
  set_cann_cpack_config(ops-ras ENABLE_DEVICE ${ENABLE_DEVICE} COMPUTE_UNIT ${ASCEND_COMPUTE_UNIT} SHARE_INFO_NAME ops_ras PACKAGE_TYPE "${PACKAGE_TYPE}")
endfunction()
